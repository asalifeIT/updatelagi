...
export class UpdateStatusAndDetailComponent {
  ...
  async updateDetail() {
    ...
    if (
      this.picInput.value === null &&
      this.durasiInput.value === null &&
      this.priorityInput.value === null
    ) {
    ...
    if (
      this.picInput.value === this.picInput &&
      this.durasiInput.value === this.duration &&
      this.priorityInput.value === this.priority
    ) {
      this.resultMessage = "Tidak ada data yang diupdate";
      this.modalController.dismiss(this.resultMessage, "resultMessage");
      loading.dismiss();
    ...
    this.serviceService
      .updateStatus(payload, "maintenance/update-order/", this.id)
      .subscribe(
        (data) => {
  ...
  async updateStatus(newStatus) {
    ...
    this.serviceService
      .updateStatus(payload, "maintenance/update-status-order/", this.id)
      .subscribe(
        (data) => {
          this.resultMessage = "success";
